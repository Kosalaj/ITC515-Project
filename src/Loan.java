...
public class Loan implements Serializable { //loan changed to Loan
	...
	public Loan(int loanId, Book book, Member member, Date dueDate) { //book changed to Book @kosala,member changed to Member
	...
	public String toString() {
		...
		sb.append("Loan:  ").append(loanId).append("\n")//ID changed to loanId @kosala
		  ...
		  .append("  Book ").append(book.ID()).append(" : " ) //B changed to book
